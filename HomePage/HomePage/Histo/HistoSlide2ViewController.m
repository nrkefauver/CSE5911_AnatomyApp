...
- (void)sidebar:(RNFrostedSidebar *)sidebar didTapItemAtIndex:(NSUInteger)index {
    ...
    //Index clicked
    if (index == 0) {
        [self performSegueWithIdentifier:@"HistoRedSlideToHistoIndexSegue" sender:self];
    }
    //Histo Home clicked
    else if (index == 1) {
        [self performSegueWithIdentifier:@"HistoRedSlideToHistoHomeSegue" sender:self];
    }
    //Home clicked
    else if (index == 2) {
        [self performSegueWithIdentifier:@"HistoRedSlideToHomeSegue" sender:self];
    }
